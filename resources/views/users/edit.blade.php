...
<div class="card bg-dark text-white">
            <h3 class="display-8" style="text-align:center;">Edit User</h3>
        </div>
<form style="background-color:#E6E6FA;font-size:20px;font-weight:bold;padding-left:20px" action="{{ route('users.update' , $user->id) }}" method="POST">
    @method('PUT')
    @csrf
    ...
    <div class="form-group">
        ...
        <input name="name" maxlength="255" type="text" class="form-control @error('name') is-invalid @enderror"
            id="name" placeholder="Ex: Steve Jobs" value="{{ old('name', $user->name) }}">
    ...
    <br>
    <div class="form-group">
        <label for="meta_name"><br>Add meta data: </label><br>
    ...
    <br>
    <div class="form-group">
    <p style="text-align:center;"><button type="submit" style="width:200px" class="btn btn-primary">Update user</button></p>
    </div>
